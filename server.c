...
"<!DOCTYPE html>\r\n"
"<html style=height:100%;' lang='it'><head><title>Raspberry Pi Surveillance</title><meta name='viewport' content='width=device-width, initial-scale=1'><link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/css/bootstrap.min.css' integrity='sha384-rwoIResjU2yc3z8GV/NPeZWAv56rSmLldC3R/AZzGRnGxQQKnKkoFVhFQhNUwEyJ' crossorigin='anonymous'><script src='https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script><script src='https://cdnjs.cloudflare.com/ajax/libs/tether/1.4.0/js/tether.min.js' integrity='sha384-DztdAPBWPRXSA/3eYEEUWrWCy7G5KFbe8fFjk5JAIxUYHKkDx6Qin1DkWx51bBrb' crossorigin='anonymous'></script><script src='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js' integrity='sha384-vBWWzlZJ8ea9aCX4pEW3rVHjgjt7zpkNpZk+02D9phzyeVkE+jo0ieGizqPLForn' crossorigin='anonymous'></script></head>\r\n"
"<body style=height:100%;'><div class='container-fluid' style='padding-left:5%; padding-right:5%;'><!-- TITLE --><div class='row'><div class='col-12 col-md-12 col-sm-12 col-xl-12'><br/><center><h3 style='font-size: 1em;'>RASPBERRY PI VIDEO SURVEILLANCE</h3></center></div></div><!-- SEZIONE LIVE --><div id='live' class='row' style='height: 70vh;'><div class='col-12 col-md-12 col-sm-12 col-xl-12'><center><img id='iframeid' class='img-responsive' style='width: 100%;height: 100%;' src='test.jpg'></center></div></div><!-- SEZIONE COMANDI --><div class='row'><div class='col-12 col-sm-12 col-md-12'><br/><center><form name='control-form' method='post'><div class='form-group'><input id='comandosx' type='submit' class='btn btn-sm btn-inline' name='comandi' value='SX (45°)'><input id='comandodx' type='submit' class='btn btn-sm btn-inline' name='comandi' value='DX (45°)'></div><div class='form-group'><label><h3 style='font-size: 1em;'>Position:</h3></label><input id='coordinate' type='number' name='position' class='form-control-inline' min='0' max='359'><input id='absoluteposition' type='submit'  name='sendposition' value='INVIA' class='btn btn-inline btn-sm'></div><div class='form-group'><label><h3 style='font-size: 1em;'>Resolution:</h3></label><input id='resolutionw' type='number' name='position' class='form-control-inline' min='240' max='2560'><input id='resolutionh' type='number' name='position' class='form-control-inline' min='240' max='1920'><input id='scatta' type='submit' class='btn btn-sm btn-inline btn-danger' name='comandi' value='SCATTA'></div></form></center></div></div></div></body>\r\n"
"</html>";
